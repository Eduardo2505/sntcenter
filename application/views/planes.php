...
<body>
	...
	<section id="our_work" class="dzen_section_DD section_with_gray_body" >
		...
		<div class="dzen_container" >
			...
			<div class="dzen_column_DD_span12">
				<img src="<?php echo site_url('') ?>images/planes integrales_preview.jpeg" alt="">
				<br>
				<br>
			</div>
			<!-- <table class="table">
				<tr style="background-color:#A4A4A4;color:#FFFFFF;text-align: center">
					<th ><br>Duración del plan</th>
					<th><br>Consultas</th>
					<th><br>Costo total</th>
					<th><br>Costo por consulta</th>
					<th>Costo total con descuento<br> de promoción (valor de<br> cada plan por separado)</th>
				</tr>
	...
	<header>
		...
		<div class="dzen_container">
			<div class="dzen_column_DD_span6">
				<img src="<?php echo site_url('') ?>images/mecanicadetrabajo.jpg" alt="">
			</div>
...
<section id="our_work" class="dzen_section_DD section_with_gray_body">
	<header>
		<div class="dzen_container" >
			<h3>¿En qué consiste la consulta y el método de trabajo?</h3>
